...
export function DrinkMenu({ onClose }: DrinkMenuProps) {
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="min-h-screen bg-black/95 backdrop-blur-xl"
    >
      {/* Header with Search */}
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-white/5 border border-white/10 rounded-xl text-white placeholder:text-white/40 focus:outline-none focus:border-[#9D5CFF] transition-colors"
              />
            </div>
          </div>
